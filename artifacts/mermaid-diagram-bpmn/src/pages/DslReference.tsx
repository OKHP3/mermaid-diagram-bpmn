...
const FLOW_OPERATORS: Row[] = [
  ...
  { syntax: "<from> ~~> <to>", description: "Message flow — dashed line with open arrowhead. Crosses pool boundaries. (v1: deferred)", example: "pool1 ~~> pool2" },
];
...
const DEFERRED_KEYWORDS: string[] = [
  "pool", "lane", "msg:start", "msg:end", "timer:start", "boundary:timer", "subprocess", "call", "annotation"
];
      ...
      <section>
        ...
        <div className="rounded-lg border border-border overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-2.5 border-b border-border bg-muted/50">
            ...
            <span className="text-xs font-mono text-muted-foreground">approval-process.bpmn-beta</span>
          </div>
          <pre className="p-4 text-xs font-mono text-foreground bg-card overflow-x-auto leading-relaxed whitespace-pre" data-testid="code-full-example">
            {FULL_EXAMPLE}
          </pre>
        </div>
      </section>
