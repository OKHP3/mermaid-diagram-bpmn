...
export const SKILLS: Skill[] = [
  {
    ...
    skillMdPreview: previewFrontmatter("process-intake-and-scope", "Process Intake & Scope", "core", "Discovery", "pir.yaml, scope-statement.md", "request-brief.md, organization-profile.md, process-taxonomy.md (optional)", []),
  },
  {
    id: "stakeholder-and-role-mapping",
    ...
    dependsOn: ["process-intake-and-scope"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("stakeholder-and-role-mapping", "Stakeholder & Role Mapping", "core", "Discovery", "stakeholder-register.yaml", "pir.yaml, role-dictionary.md, organization-profile.md", ["process-intake-and-scope"]),
  },
  {
    id: "elicitation-and-interview-facilitation",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("elicitation-and-interview-facilitation", "Elicitation & Interview Facilitation", "core", "Discovery", "question-plan.yaml, elicitation-notes.md", "pir.yaml, scope-statement.md, sector-context.md", ["process-intake-and-scope"]),
  },
  {
    id: "as-is-process-capture",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("as-is-process-capture", "As-Is Process Capture", "core", "Narrative", "as-is-process.yaml", "pir.yaml", ["process-intake-and-scope"]),
  },
  {
    id: "process-narrative-authoring",
    ...
    dependsOn: ["process-intake-and-scope", "stakeholder-and-role-mapping"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("process-narrative-authoring", "Process Narrative Authoring", "core", "Narrative", "pns.yaml, pns.md", "pir.yaml, stakeholder-register.yaml, business-glossary-and-rulebook.md", ["process-intake-and-scope", "stakeholder-and-role-mapping"]),
  },
  {
    id: "visual-process-modeling",
    ...
    dependsOn: ["process-narrative-authoring"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("visual-process-modeling", "Visual Process Modeling", "core", "Visual Modeling", "bpmn-beta.mmd, process-model.svg", "pns.yaml, notation-preferences.md, role-dictionary.md", ["process-narrative-authoring"]),
  },
  {
    id: "process-gap-and-exception-analysis",
    ...
    dependsOn: ["as-is-process-capture"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("process-gap-and-exception-analysis", "Gap & Exception Analysis", "core", "Narrative", "gap-analysis.yaml, exception-catalog.yaml", "pns.yaml, compliance-controls-registry.md, organization-profile.md", ["as-is-process-capture"]),
  },
  {
    id: "future-state-and-change-strategy",
    ...
    dependsOn: ["process-gap-and-exception-analysis"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("future-state-and-change-strategy", "Future-State & Change Strategy", "recommended-extension", "Narrative", "future-state.yaml, change-strategy.md", "pns.yaml, gap-analysis.yaml, organization-profile.md", ["process-gap-and-exception-analysis"]),
  },
  {
    id: "decision-model-authoring",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("decision-model-authoring", "Decision Model Authoring", "recommended-extension", "Visual Modeling", "decision-model.yaml, dmn-table.md", "pns.yaml, business-glossary-and-rulebook.md, notation-preferences.md", ["process-narrative-authoring"]),
  },
  {
    id: "process-validation-and-quality-scoring",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("process-validation-and-quality-scoring", "Validation & Quality Scoring", "core", "Narrative", "validation-report.yaml", "pns.yaml, pir.yaml", ["process-narrative-authoring"]),
  },
  {
    id: "process-measures-and-controls-definition",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("process-measures-and-controls-definition", "Measures & Controls Definition", "recommended-extension", "Operational", "measures-register.yaml, controls-register.yaml", "pns.yaml, compliance-controls-registry.md, organization-profile.md", ["process-narrative-authoring"]),
  },
  {
    id: "sop-and-work-instruction-generation",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("sop-and-work-instruction-generation", "SOP & Work Instruction Generation", "core", "Operational", "sop.md, work-instructions.md", "pns.yaml, organization-profile.md, regional-context.md, role-dictionary.md", ["process-narrative-authoring"]),
  },
  {
    id: "raci-and-governance-matrix-generation",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("raci-and-governance-matrix-generation", "RACI & Governance Matrix", "core", "Governance", "raci.md, governance-matrix.md", "pns.yaml, role-dictionary.md, organization-profile.md", ["process-narrative-authoring"]),
  },
  {
    id: "sipoc-generation",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("sipoc-generation", "SIPOC Generation", "core", "Governance", "sipoc.md", "pns.yaml, pir.yaml", ["process-narrative-authoring"]),
  },
  {
    id: "publication-and-handoff-packaging",
    name: "publication-and-handoff-packaging",
    ...
    dependsOn: ["process-narrative-authoring", "visual-process-modeling", "sop-and-work-instruction-generation"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("publication-and-handoff-packaging", "Publication & Handoff Packaging", "core", "Publication", "MANIFEST.yaml, APPROVALS.yaml, CHANGELOG.md", "pns.yaml, bpmn-beta.mmd, sop.md", ["process-narrative-authoring", "visual-process-modeling", "sop-and-work-instruction-generation"]),
  },
];
...
export const VARIABLE_FILES: VariableFile[] = [
  {
    ...
    usedBy: ["process-intake-and-scope", "process-validation-and-quality-scoring", "process-measures-and-controls-definition", "sop-and-work-instruction-generation", "publication-and-handoff-packaging"],
  },
  {
    id: "sector-context",
    ...
    usedBy: ["elicitation-and-interview-facilitation", "process-narrative-authoring", "process-validation-and-quality-scoring"],
  },
  {
    id: "regional-context",
    ...
    usedBy: ["sop-and-work-instruction-generation", "publication-and-handoff-packaging"],
  },
  {
    id: "role-dictionary",
    ...
    usedBy: ["stakeholder-and-role-mapping", "visual-process-modeling", "sop-and-work-instruction-generation", "raci-and-governance-matrix-generation", "process-validation-and-quality-scoring"],
  },
  {
    id: "process-taxonomy",
    ...
    usedBy: ["process-intake-and-scope", "sipoc-generation", "publication-and-handoff-packaging"],
  },
  {
    ...
    usedBy: ["visual-process-modeling", "decision-model-authoring"],
  },
  {
    ...
    usedBy: ["process-gap-and-exception-analysis", "process-measures-and-controls-definition", "sop-and-work-instruction-generation", "process-validation-and-quality-scoring", "publication-and-handoff-packaging"],
  },
  {
    ...
    usedBy: ["as-is-process-capture", "visual-process-modeling", "future-state-and-change-strategy", "publication-and-handoff-packaging"],
  },
  {
    ...
    usedBy: ["process-narrative-authoring", "decision-model-authoring", "process-validation-and-quality-scoring", "publication-and-handoff-packaging"],
  },
];

export const PNS_LIFECYCLE: PnsLifecycleState[] = [
  { status: "draft-intake",      setBy: "process-intake-and-scope",                order: 1 },
  { status: "scoped",            setBy: "stakeholder-and-role-mapping",             order: 2 },
  { status: "elicited",          setBy: "elicitation-and-interview-facilitation",   order: 3 },
  { status: "documented-as-is",  setBy: "as-is-process-capture",                   order: 4 },
  { status: "modeled",           setBy: "process-narrative-authoring",              order: 5 },
  { status: "analyzed",          setBy: "process-gap-and-exception-analysis",       order: 6 },
  { status: "validated",         setBy: "process-validation-and-quality-scoring",   order: 7 },
  { status: "packaged",          setBy: "publication-and-handoff-packaging",        order: 8 },
  { status: "published",         setBy: "publication-and-handoff-packaging",        order: 9 },
...
export const PNS_SECTIONS: PnsSection[] = [
  ...
  },
  {
    ...
    documents: "Target-state assumptions, change strategy summary, transition path, implementation dependencies. Populated by future-state-and-change-strategy skill.",
