...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    dependsOn: ["stakeholder-and-role-mapping"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("elicitation-and-interview-facilitation", "Elicitation & Interview Facilitation", "core", "Discovery", "question-plan.yaml, elicitation-notes.md", "pir.yaml, scope-statement.md, sector-context.md", ["stakeholder-and-role-mapping"]),
  },
  {
    ...
    dependsOn: ["elicitation-and-interview-facilitation"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("as-is-process-capture", "As-Is Process Capture", "core", "Narrative", "as-is-process.yaml", "pir.yaml", ["elicitation-and-interview-facilitation"]),
  },
  {
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("process-narrative-authoring", "Process Narrative Authoring", "core", "Narrative", "pns.yaml, pns.md", "pir.yaml, stakeholder-register.yaml, business-glossary-and-rulebook.md", ["as-is-process-capture"]),
  },
  {
  ...
  },
  {
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("process-gap-and-exception-analysis", "Gap & Exception Analysis", "core", "Narrative", "gap-analysis.yaml, exception-catalog.yaml", "pns.yaml, compliance-controls-registry.md, organization-profile.md", ["process-narrative-authoring"]),
  },
  {
  ...
  },
  {
    ...
    dependsOn: ["process-validation-and-quality-scoring"],
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("process-measures-and-controls-definition", "Measures & Controls Definition", "recommended-extension", "Operational", "measures-register.yaml, controls-register.yaml", "pns.yaml, compliance-controls-registry.md, organization-profile.md", ["process-validation-and-quality-scoring"]),
  },
  {
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("sop-and-work-instruction-generation", "SOP & Work Instruction Generation", "core", "Operational", "sop.md, work-instructions.md", "pns.yaml, organization-profile.md, regional-context.md, role-dictionary.md", ["process-validation-and-quality-scoring"]),
  },
  {
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("raci-and-governance-matrix-generation", "RACI & Governance Matrix", "core", "Governance", "raci.md, governance-matrix.md", "pns.yaml, role-dictionary.md, organization-profile.md", ["stakeholder-and-role-mapping"]),
  },
  {
    id: "sipoc-generation",
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("sipoc-generation", "SIPOC Generation", "core", "Governance", "sipoc.md", "pns.yaml, pir.yaml", ["process-intake-and-scope"]),
  },
  {
    ...
    compatibleWith: COMPATIBLE_PLATFORMS,
    skillMdPreview: previewFrontmatter("publication-and-handoff-packaging", "Publication & Handoff Packaging", "core", "Publication", "MANIFEST.yaml, APPROVALS.yaml, CHANGELOG.md", "pns.yaml, bpmn-beta.mmd, sop.md", ["process-validation-and-quality-scoring"]),
  },
];
