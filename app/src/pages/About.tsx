    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
      <div className="mb-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground max-w-2xl leading-relaxed">
          The governance record for <code className="font-mono text-xs bg-muted px-1 py-0.5 rounded">bpmn-beta</code>,
      ...
      <section className="mb-14">
        ...
        <div className="max-w-2xl p-5 rounded-lg border border-border bg-card">
          <p className="text-sm text-muted-foreground leading-relaxed">
            The complete rationale, status, and history for product and architecture decisions
            live in the canonical decision log.
          </p>
          <ExternalLinkAnchor
            href="https://github.com/OKHP3/mermaid-diagram-bpmn/blob/main/app/docs/decisions.md"
            className="mt-3 text-sm font-semibold text-primary hover:underline underline-offset-2"
            data-testid="link-decision-log"
          >
            Read the canonical decision log
          </ExternalLinkAnchor>
          <p className="mt-3 text-xs text-muted-foreground/70 leading-relaxed">
            Contributors: update <code className="font-mono">app/docs/decisions.md</code> when
            a decision changes; this page intentionally does not duplicate those records.
          </p>
        </div>
      </section>
