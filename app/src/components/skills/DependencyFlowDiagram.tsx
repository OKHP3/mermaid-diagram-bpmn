...
const POSITIONS: Record<string, [number, number]> = {
  "okhp3-process-intake-and-scope":                [0, 3],
  "okhp3-stakeholder-and-role-mapping":            [1, 1],
  "okhp3-elicitation-interviews":  [1, 3],
  "okhp3-as-is-process-capture":                   [1, 6],
  "okhp3-process-narrative-authoring":             [2, 3],
  "okhp3-process-gap-exception-analysis":      [2, 6],
  "okhp3-visual-process-modeling":                 [3, 0],
  "okhp3-decision-model-authoring":                [3, 1],
  "okhp3-process-validation-scoring":  [3, 2],
  "okhp3-process-measures-controls":[3, 3],
  "okhp3-sop-work-instructions":     [3, 4],
  "okhp3-raci-governance-matrix":   [3, 5],
  "okhp3-sipoc-generation":                        [3, 6],
  "okhp3-future-state-change-strategy":        [3, 7],
  "okhp3-publication-handoff-packaging":       [4, 3],
};

const SHORT: Record<string, string> = {
  "okhp3-process-intake-and-scope":                "Intake & Scope",
  "okhp3-stakeholder-and-role-mapping":            "Stakeholder Map",
  "okhp3-elicitation-interviews":  "Elicitation",
  "okhp3-as-is-process-capture":                   "As-Is Capture",
  "okhp3-process-narrative-authoring":             "Narrative Auth.",
  "okhp3-visual-process-modeling":                 "Visual Modeling",
  "okhp3-process-gap-exception-analysis":      "Gap Analysis",
  "okhp3-future-state-change-strategy":        "Future State",
  "okhp3-decision-model-authoring":                "Decision Model",
  "okhp3-process-validation-scoring":  "Validation",
  "okhp3-process-measures-controls":"Measures",
  "okhp3-sop-work-instructions":     "SOP & WIs",
  "okhp3-raci-governance-matrix":   "RACI Matrix",
  "okhp3-sipoc-generation":                        "SIPOC",
  "okhp3-publication-handoff-packaging":       "Publication",
};
